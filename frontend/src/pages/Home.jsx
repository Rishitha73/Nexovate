...
const CheckIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
    <circle cx="9" cy="9" r="9" fill="#8b5cf6" opacity="0.15"/>
    <path d="M5 9l3 3 5-5" stroke="#8b5cf6" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh" }}>
        ...
        {/* Workflow Diagram */}
        <section style={{ background: "white", padding: "80px 60px", borderTop: "1px solid #f0eeff" }}>
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>

              <div className="workflow-step">
                <div className="workflow-icon" style={{ background: "#f5f3ff", border: "2px solid #ede9fe" }}>
                  👤
                </div>
              ...
              <div className="workflow-step" style={{ position: "relative" }}>
                <div className="pulse-glow" style={{
                  ...
                  <div style={{ color: "#8b5cf6", fontWeight: 700, fontSize: 14, marginBottom: 16 }}>Leeco Agent</div>
              ...
              <div className="workflow-step">
                <div className="workflow-icon pulse-glow" style={{ background: "#8b5cf6", border: "2px solid #7c3aed" }}>
                  🏆
                </div>
                <span style={{ fontSize: 13, fontWeight: 700, color: "#8b5cf6" }}>Placed!</span>
              </div>
        ...
        <section style={{ padding: "100px 60px", background: "#faf9ff" }}>
              ...
              <div style={{ display: "flex", gap: 20, alignItems: "flex-start" }}>
                ...
                <div className="resume-card card-hover" style={{
                  ...
                  <div style={{
                    ...
                    background: "#ede9fe", padding: "4px 12px", borderRadius: 99,
                    display: "inline-block", marginBottom: 20
                  }}>✨ Leeco Optimized</div>
                  ...
                  <div style={{ marginTop: 20, paddingTop: 16, borderTop: "1px solid #ede9fe" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                      <span style={{ fontSize: 12, color: "#9ca3af" }}>ATS Score</span>
                      <span style={{ fontSize: 13, fontWeight: 700, color: "#7c3aed" }}>95%</span>
                    </div>
                    <div className="progress-bar">
                      <div className="progress-fill" style={{ "--target-width": "95%", width: "95%", background: "linear-gradient(90deg, #8b5cf6, #6366f1)" }} />
                    </div>
                  </div>
                </div>
              </div>
